...
def get_upgrade_abilities(data):
    ...
    for entry in unit_data:
        ...
        if unit_type == UnitTypeId.ROACHWARREN:
            current_unit_research_abilities[UpgradeId.GLIALRECONSTITUTION] = {
                "upgrade": UpgradeId.GLIALRECONSTITUTION,
                "ability": AbilityId.RESEARCH_GLIALREGENERATION,
                "requires_tech_building": UnitTypeId.LAIR,
            }
            current_unit_research_abilities[UpgradeId.TUNNELINGCLAWS] = {
